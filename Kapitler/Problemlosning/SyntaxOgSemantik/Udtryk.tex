...
\noindent Herunder ses semantikken for "And expression". Hvis der tages udgangspunkt i \textit{AND-1} skal semantikken læses således: Hvis and_expr er true og equality_expr er true så er udtrykket and_expr og equality_expr 
