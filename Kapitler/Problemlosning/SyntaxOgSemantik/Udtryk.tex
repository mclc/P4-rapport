...
Sammenlignings udtryk kommer i seks forskellige varianter. Mindre end, mindre end eller lig med, større end, større end eller lig med, lig med og forskellig fra hinanden. Her vises dog kun "lig med". De resterende kan ses i bilag.
    ...
    \noindent Herunder ses semantikken for \textit{Equality expression}. Hvis der taget udgangspunkt i \textit{EQUALS-T} læses gramatikken således: Hvis equality\_expr evaluerer til v1 og greater\_less\_expr evaluerer til v2 så er equality\_expr lig med greater\_less\_expr true, hvis v1 og v2 er lig med hinanden.
