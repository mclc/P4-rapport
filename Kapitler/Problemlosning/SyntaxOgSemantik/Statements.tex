...
Blablabla...\mfix{Mikkel er mongol} Deklaration af funktioner findes i semantik x.x \mfix{Ref til funktionsdeclaration}

Der bliver brugt pass by value...

\input{Kode/CFG/BNF_call.tex}
