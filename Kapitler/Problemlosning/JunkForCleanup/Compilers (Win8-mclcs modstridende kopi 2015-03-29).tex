...
En scanner indlæser de forskellige "ord"\mbox{}, og laver dem om til tokens som parseren senere kan bruge. Et eksempel på en meget simpel scanner i Java kunne være:
...
%\input{Kapitler/Problemlosning/ContextAnalysis.tex}
