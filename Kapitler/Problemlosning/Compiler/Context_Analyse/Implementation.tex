...
\Java{Kode/ExprTypeEvaluator.java}{Push af konstanters type på stacken som giver mulighed for typecheck (omskrevet eksempel fra programmet)}{exprTypeEvaluator}
