...
\AnsiC{Kode/SymTableExample.c}{Program brugt til at danne følgende symbol tabel}{tableprog}
    ...
    \tikzfigure{Figurer/TikZ/SymbolTable.tex}{Flere symbol tabeller som de fungere i compileren til \sprognavn}{symtab}
