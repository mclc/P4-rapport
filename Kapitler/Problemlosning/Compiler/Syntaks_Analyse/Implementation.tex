...
Alle referencer i produktionsreglerne til \gls{ast} sker vha. akkolader. \sfix{Kan det defineres mere klart?}
...
På kode \ref{code:cfgtokens} ses en række tokens som lexeren\sfix{Lexer vs scanner} skal genkende. Herunder parenteser, og operatoren og eller operatoren samt while keywordet.
