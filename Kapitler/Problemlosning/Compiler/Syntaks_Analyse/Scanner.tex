...
\noindent En scanner indlæser de forskellige "ord"\mbox{}, og laver dem om til tokens som parseren senere kan bruge. Et eksempel på en scanner til følgende tokens implementeret i Java kan ses i bilag \sfix{Bilag med scanner} eller i et udsnit i kode \ref{code:scanner_java}.
...
% Q#0.0 = true;
\PPP{Kode/Port/SimplePort.tex}{Eksempel på kodestykke på port}{port_simple}
