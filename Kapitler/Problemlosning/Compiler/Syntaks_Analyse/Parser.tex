...
\noindent Et af kendetegnene ved en \gls{dfa} er at ethvert input altid skal føre ét, og kun ét, sted hen - enten til sig selv eller et andet stadie. Dette resulterer også i at den tomme streng, $\epsilon$, ikke findes i alfabeter for \gls{dfa}'er. Disse regler er dog ikke gældende for en \gls{nfa}, som det ses på eksemplet i figur \ref{fig:regextonfa}, hvor $\epsilon$ betyder at vi kan gå i to forskellige stadier med samme input.
