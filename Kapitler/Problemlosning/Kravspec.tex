...
\Cobol{Kode/Readability-cobol.cbl}{Viser et for-loop skrevet i sproget COBOL}{ekscobol}
...
\CSharp{Kode/Readability-csharp.cs}{Viser et for-loop skrevet i sproget C\#}{ekscsharp}
