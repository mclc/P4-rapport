...
Kontrolstruktuer er placeret som ét must-have da kontrolstrukturer er en central del af programmering.
Derfor vælges der at implementere \textit{if} og \textit{while}, med henblik på senere hen at implementere \textit{for}, \textit{do-while} samt \textit{switch}.
...
Dette giver programmøren uafhængighed i forhold til hvilken producent programmøren vil arbejde med.\\\sfix{Mindre vigtigt}
