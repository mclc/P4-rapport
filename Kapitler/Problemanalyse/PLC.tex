...
% Rasp 2
% 1.186 MIPS (Rasp PI) = 1.186 * 10^3 kIPS = 1.186 * 10^6 IPS

% 1.186 * 10^6 IPS = 1.000.000 /µ / x µSPI
% 1.186 * 10^6 IPS * x µSPI = 1.000.000 /µ
% x µSPI = 1.000.000 /µ / 1.186 * 10^6 IPS
% 0,000843 µSPI = 1.000.000 /µ / 1.186 * 10^6 IPS

%CP1H 0.1 µs pr. LD instruction
% 0,1 µSPI = 1.000.000 /µ / x IPS
% 0,1 µSPI * x IPS = 1.000.000 /µ
% x IPS = 1.000.000 / µ * 0,1 µSPI
% 100.000 IPS = 1.000.000 / µ * 0.1 µSPI
% 100 kIPS
