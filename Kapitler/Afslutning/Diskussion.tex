...
\subsection*{Stack}
Stacken i sig selv har sine problemer, ud over den har en masse spild plads, så bliver den defineret i \gls{il}-koden uanset om den bliver brugt eller ej. Dette blev implementeret sådan for at sikre at stacken altid var initialisere når den skal bruges. Det kan sagtens tænkes at 

%Et punkt hvor PLC++

%Port kan ikke skiftes i gramma ikke i codegen 
%Strings ikke implementeret