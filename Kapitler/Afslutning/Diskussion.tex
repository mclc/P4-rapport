...
Valget af paradigme blev hurtigt truffet i projektet, og på baggrund af egne erfaringer med \gls{plc}, samt undersøgelsen af hvad virksomheder benytter \gls{plc}er til, viste det sig at være mest logisk at vælge det imperativ paradigme.
...
En anden grund til at det imperative paradigme blev valgt, er fordi det er reletivt simpelt, og en almindelig person kan forholde sig til det, med meget lidt erfaringen indenfor sproget. 
...
På nuværende stadige, kan man skrive \gls{il} til en \gls{plc}, hvilket giver en tekstbaseret programmeringsformat, i stedet for ladderprogramming, som er en graffisk platform.
Dette giver mulighed for at skrive i et sprog, som er mere kompakt, og derved tager kortere tid at skrive. Udfordringen ved det, er at det ikke er særlig let at lære, da man skal huske opbygningen af funktioner, samt referencer til de enkelte kald som man skal foretage.
Ligeledes er der ikke behov for den kompleksitet som det objektorienteret paradigme giver, da \gls{plc} programmer for det mest er opbygget i flere sektioner, som hver i sær håndtere hver deres opgave.
Derved vurderes det at det imperative paradigme er det mest passende, i forhold til de opstillede krav, omkring simplicitet og 
