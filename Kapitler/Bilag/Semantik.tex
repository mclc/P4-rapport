...
\noindent For at gøre disse regler mere overskuelige, er expressions delt ind i arismetiske og boolske expressions.\\
...
%
&[CALL] & & \frac{Env^\prime_V\big[ x\mapsto l\big]\big[next\mapsto l^\prime\big], Env_F\vdash\langle S, sto\rangle\to sto^\prime}{Env_V, Env_F\vdash\langle F(y), sto\rangle\to sto^\prime} & &
\begin{array}{l}
